    ...
    <div id="primaryContainer" class="primaryContainer clearfix">
        ...
        <div id="Container" class="clearfix">
            ...
            <div id="Content" class="clearfix">
                <p id="text6">
                    <span id="textspan1">Hier kan medewerkers toevoegen.
                        <form method="POST" action="">
                            <table class="no-border">
                                <thead><tr><td>Medewerker</td><td>toevoegen</td></tr></thead>
                                <tbody>
                                    <tr><td>Naam:</td><td><input type="text" name="txtNaam"></td></tr>
                                    <tr><td>GSM:</td><td><input type="text" name="txtGsm"></td></tr>
                                    <tr><td>Email:</td><td><input type="text" name="txtEmail"></td></tr>
                                    <tr><td>Werkzaam:</td><td><input type="text" name="txtWerkzaam"></td></tr>
                        ...
                        <?php
                            if(isset($_POST['btnSave'])){
                                ...
                                insert_medewerker($txtNaam, $txtGsm, $txtEmail, $txtWerkzaam, $txtFunctie);
                            }
                        ?>
                    </span>
                </p>
