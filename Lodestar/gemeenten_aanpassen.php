    ...
    <div id="primaryContainer" class="primaryContainer clearfix">
        ...
        <div id="Container" class="clearfix">
            ...
            <div id="Content" class="clearfix">
                <p id="text6">
                    <span id="textspan1">Hier kan je gemeenten aanpassen.
                        <form method="POST" action="">
                            <table class="no-border">
                                <thead><tr><td>Gemeente</td><td>aanpassen</td></tr></thead>
                                <tbody>
                                    <?php
                                        get_gemeente($gemeente_id);
                                    ?>
                        ...
                        <?php
                            if(isset($_POST['btnSave'])){
                                ...
                                $txtUrl = $_POST['txtUrl'];
                                update_gemeente($gemeente_id, $txtType, $txtNaam, $txtUrl);
                            }
                        ?>
                    </span>
                </p>
